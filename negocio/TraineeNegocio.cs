...
namespace negocio
{
    public class TraineeNegocio
    {
        ...
        //public void cargarUser(Trainee user)
        //{
        //    AccesoDatos datos = new AccesoDatos();
        //    try
        //    {
        //        datos.setearConsulta("Select nombre, apellido, email, imagenPerfil from USERS Where nombre = @nombre And apellido = @apellido And email = @email");
        //        datos.setearParametro("@nombre", user.Nombre);
        //        datos.setearParametro("@apellido", user.Apellido);
